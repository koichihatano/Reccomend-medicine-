...
post1 = user2.posts.create!(content: "喉ならルルアタックEX")
post2 = user1.posts.create!(content: "熱ならルルアタックFX")
post3 = user3.posts.create!(content: "咳なら赤いパッケージのストナ")
post4 = user3.posts.create!(content: "鼻水ならルルアタックNX")
post5 = user1.posts.create!(content: "頭痛ならリングルアイビー200")
